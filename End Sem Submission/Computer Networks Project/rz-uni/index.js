string = "";
string+="In this type of unipolar signaling, Half of the bit duration remains"
string+="high but it immediately returns to zero and shows the absence of "
string+="pulse during the remaining half of the bit duration."
...
function plot(){
	...
	else
	{
		...
		else
		{
			...
			Plotly.newPlot('rz-uni', data, layout);
		}
